  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground">Effective Date: May 2025</p>
      </motion.div>
      ...
      <Card className="p-6 space-y-8 bg-background/95">
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-2">
            To exercise these rights, please contact us at rezaafk021@gmail.com.
          </p>
        </section>
