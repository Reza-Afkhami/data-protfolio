...
const socialLinks = [
  { icon: Github, href: "https://github.com/Reza-Afkhami" },
  { icon: Linkedin, href: "https://linkedin.com/in/reza-afkhami-a6276a332" },
  { icon: Database, href: "https://www.kaggle.com/rezaafk"}
]
      ...
      <div className="flex h-full flex-col justify-between px-4 py-8">
        <div>
          <div className="mb-8 px-2">
            <h1 className="text-2xl font-bold">Reza Afkhami</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center text-sm text-muted-foreground border-t pt-4">
            © {new Date().getFullYear()} Reza Afkhami. All rights reserved.
          </div>
        </div>
      </div>
    </aside>
